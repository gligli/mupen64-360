...
void (*rw_nothing[8])() ={read_nothing, read_nothingb, read_nothingh, read_nothingd,
	write_nothing, write_nothingb, write_nothingh, write_nothingd};

void (*rw_nomem[8])() ={read_nomem, read_nomemb, read_nomemh, read_nomemd,
	write_nomem, write_nomemb, write_nomemh, write_nomemd};

void (*rw_rdram[8])() ={read_rdram, read_rdramb, read_rdramh, read_rdramd,
	write_rdram, write_rdramb, write_rdramh, write_rdramd};

void (*rw_rdramFB[8])() ={read_rdramFB, read_rdramFBb, read_rdramFBh, read_rdramFBd,
	write_rdramFB, write_rdramFBb, write_rdramFBh, write_rdramFBd};

void (*rw_rdramreg[8])() ={read_rdramreg, read_rdramregb, read_rdramregh, read_rdramregd,
	write_rdramreg, write_rdramregb, write_rdramregh, write_rdramregd};

void (*rw_rsp_mem[8])() ={read_rsp_mem, read_rsp_memb, read_rsp_memh, read_rsp_memd,
	write_rsp_mem, write_rsp_memb, write_rsp_memh, write_rsp_memd};

void (*rw_rsp_reg[8])() ={read_rsp_reg, read_rsp_regb, read_rsp_regh, read_rsp_regd,
	write_rsp_reg, write_rsp_regb, write_rsp_regh, write_rsp_regd};

void (*rw_rsp[8])() ={read_rsp, read_rspb, read_rsph, read_rspd,
	write_rsp, write_rspb, write_rsph, write_rspd};

void (*rw_dp[8])() ={read_dp, read_dpb, read_dph, read_dpd,
	write_dp, write_dpb, write_dph, write_dpd};

void (*rw_dps[8])() ={read_dps, read_dpsb, read_dpsh, read_dpsd,
	write_dps, write_dpsb, write_dpsh, write_dpsd};

void (*rw_mi[8])() ={read_mi, read_mib, read_mih, read_mid,
	write_mi, write_mib, write_mih, write_mid};

void (*rw_vi[8])() ={read_vi, read_vib, read_vih, read_vid,
	write_vi, write_vib, write_vih, write_vid};

void (*rw_ai[8])() ={read_ai, read_aib, read_aih, read_aid,
	write_ai, write_aib, write_aih, write_aid};

void (*rw_pi[8])() ={read_pi, read_pib, read_pih, read_pid,
	write_pi, write_pib, write_pih, write_pid};

void (*rw_ri[8])() ={read_ri, read_rib, read_rih, read_rid,
	write_ri, write_rib, write_rih, write_rid};

void (*rw_si[8])() ={read_si, read_sib, read_sih, read_sid,
	write_si, write_sib, write_sih, write_sid};

void (*rw_flashram0[8])() ={read_flashram_status, read_flashram_statusb,
...
void (*rw_flashram1[8])() ={read_nothing, read_nothingb,
	read_nothingh, read_nothingd,
	write_flashram_command, write_flashram_commandb,
	write_flashram_commandh, write_flashram_commandd};

void (*rw_rom0[8])() ={read_rom, read_romb, read_romh, read_romd,
	write_nothing, write_nothingb, write_nothingh, write_nothingd};

void (*rw_rom1[8])() ={read_rom, read_romb, read_romh, read_romd,
	write_rom, write_nothingb, write_nothingh, write_nothingd};

void (*rw_pif[8])() ={read_pif, read_pifb, read_pifh, read_pifd,
