...
{
    if( CDeviceBuilder::GetGeneralDeviceType() == XENOS_DEVICE )
    {
...
BOOL InitConfiguration(void)
{
    ...
    ConfigSetDefaultInt(l_ConfigVideoRice, "OpenGLRenderSetting", XENOS_DEVICE, "OpenGL level to support (0=auto, 1=OGL_1.1, 2=OGL_1.2, 3=OGL_1.3, 4=OGL_1.4, 5=OGL_1.4_V2, 6=OGL_TNT2, 7=NVIDIA_OGL, 8=OGL_FRAGMENT_PROGRAM)");
...
static void ReadConfiguration(void)
{
    ...
    options.OpenglDepthBufferSetting = 32;
    options.multiSampling = 0;
    options.colorQuality = TEXTURE_FMT_A8R8G8B8;
    options.OpenglRenderSetting = XENOS_DEVICE;
...
/*gli    if (l_ConfigVideoGeneral == NULL || l_ConfigVideoRice == NULL)
    {
