...
extern "C" EXPORT void CALL romClosed_gfx(void);
...
EXPORT m64p_error CALL rice_PluginStartup(m64p_dynlib_handle CoreLibHandle, void *Context,
...
EXPORT m64p_error CALL rice_PluginShutdown(void)
{
    if (!l_PluginInit)
...
EXPORT m64p_error CALL rice_PluginGetVersion(m64p_plugin_type *PluginType, int *PluginVersion, int *APIVersion, const char **PluginNamePtr, int *Capabilities)
{
    /* set version info */
    if (PluginType != NULL)
...
EXPORT void CALL rice_ChangeWindow (void)
{
...
EXPORT void CALL rice_MoveScreen (int xpos, int ypos)
{ 
}

//---------------------------------------------------------------------------------------
EXPORT void CALL romClosed_gfx(void)
{
...
EXPORT int CALL romOpen_gfx(void)
{
...
EXPORT void CALL rice_FBRead(uint32 addr)
{
...
EXPORT void CALL rice_FBWrite(uint32 addr, uint32 size)
{
...
EXPORT void CALL rice_FBGetFrameBufferInfo(void *p)
{
	assert(false);
#if 0 //gli
...
EXPORT void CALL rice_ReadScreen2(void *dest, int *width, int *height, int bFront)
{
	assert(false);
#if 0 //gli
...
EXPORT void CALL rice_SetRenderingCallback(void (*callback)(int))
{
