...
unsigned long __attribute__((aligned(128))) i, r4300emu = 0, interpcore = 0;
int no_audio_delay = 0;
int no_compiled_jump = 0;
int __attribute__((aligned(128))) stop, llbit;
unsigned long long int __attribute__((aligned(128))) reg[34];
...
void r4300_reset_hard(void)
{
	...
	Random = 31;
	Status = 0x34000000;
	//gli TODO    set_fpr_pointers(Status);
	Config = 0x6e463;
	PRevID = 0xb00;
	Count = 0x5000;
	Cause = 0x5C;
