	...
	if (check_nop)
	  {
	     dst->ops = BLTZ_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbltz_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbltz();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BLTZ_OUT;
	//if(r4300emu)
	//if(r4300emu) genbltz_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbltz();
}
	...
	if (check_nop)
	  {
	     dst->ops = BLTZL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbltzl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbltzl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BLTZL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbltzl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbltzl();
}
	...
	if (check_nop)
	  {
	     dst->ops = BGEZL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbgezl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbgezl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BGEZL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbgezl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbgezl();
}
	...
	if (check_nop)
	  {
	     dst->ops = BLTZAL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbltzal_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbltzal();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BLTZAL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbltzal_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbltzal();
}
	...
	if (check_nop)
	  {
	     dst->ops = BGEZAL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbgezal_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbgezal();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BGEZAL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbgezal_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbgezal();
}
...
static void RBLTZALL()
{
   ...
   if (target == dst->addr)
	...
	if (check_nop)
	  ...
	  //if(r4300emu)
	//if(r4300emu) genbltzall_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbltzall();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BLTZALL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbltzall_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbltzall();
}
...
static void RBGEZALL()
{
   ...
   if (target == dst->addr)
	...
	if (check_nop)
	  ...
	  //if(r4300emu)
	//if(r4300emu) genbgezall_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbgezall();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BGEZALL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbgezall_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbgezall();
}
	...
	if (check_nop)
	  {
	     dst->ops = BC1FL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbc1fl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbc1fl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BC1FL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbc1fl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbc1fl();
}
	...
	if (check_nop)
	  {
	     dst->ops = BC1TL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbc1tl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbc1tl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BC1TL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbc1tl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbc1tl();
}
	...
	if (check_nop)
	  {
	     dst->ops = BLEZL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genblezl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genblezl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BLEZL_OUT;
	//if(r4300emu)
	//if(r4300emu) genblezl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genblezl();
}
	...
	if (check_nop)
	  {
	     dst->ops = BGTZL_IDLE;
	  //if(r4300emu)
	//if(r4300emu) genbgtzl_idle();
	  }
	//else //if(r4300emu)
	//if(r4300emu) genbgtzl();
     }
   else if ((!interpcore && !r4300emu) && (target < dst_block->start || target >= dst_block->end || dst->addr == (dst_block->end-4)))
     {
	dst->ops = BGTZL_OUT;
	//if(r4300emu)
	//if(r4300emu) genbgtzl_out();
     }
   //else //if(r4300emu)
	//if(r4300emu) genbgtzl();
}
