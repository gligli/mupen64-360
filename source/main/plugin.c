...
static BOOL dummy_initiateGFX(GFX_INFO Gfx_Info) {
	return TRUE;
}

static BOOL dummy_initiateAudio(AUDIO_INFO Audio_Info) {
	return TRUE;
}
...
static DWORD dummy_aiReadLength() {
	return 0;
}
...
static DWORD dummy_doRspCycles(DWORD Cycles) {
	return Cycles;
};
